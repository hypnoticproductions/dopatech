    ...
    <section className="min-h-screen bg-gradient-to-b from-black via-orange-900/10 to-black pt-32 pb-20 px-6 lg:px-12 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="flex justify-center gap-6">
          <a href="#" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-pink-500 hover:text-white hover:border-pink-500 transition-all duration-300 hover:scale-110">
            <Instagram size={20} />
          </a>
          <a href="#" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-cyan-500 hover:text-white hover:border-cyan-500 transition-all duration-300 hover:scale-110">
            <Twitter size={20} />
          </a>
